...
CPU, a tiny quasi-2D grating_coupler scene (the same coarse-grid/short-sim-time recipe
...
writing, sha256, resume-by-skip, the optional spectrum column — not grating_coupler
...
def _tiny_cfg(**overrides):
    """Same tiny quasi-2D grating_coupler scene as test_fdtdx_perf._tiny_cfg (coarse
