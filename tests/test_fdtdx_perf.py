...
from invdx.problems.grating_coupler import GratingCouplerConfig, build_scene, uniform_grating_teeth


def _tiny_cfg(**overrides) -> GratingCouplerConfig:
    """Small quasi-2D grating_coupler scene: coarse grid, short run, keeps CI fast."""
...
def test_bitwise_equivalence_grating_coupler_quasi2d():
...
def test_bitwise_equivalence_3d_all_pml_reclaim():
    ...
    from invdx.problems.grating_coupler import build_scene_3d
