...
Checkpointing is not optional polish here: one grating_coupler inverse-design round is
...
module free of fdtdx/grating_coupler imports is what makes the resume path unit-testable
without a GPU (tests/test_grating_coupler_optimize.py).
