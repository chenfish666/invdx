"""Child side of the cross-env Meep protocol — runs INSIDE conda env `meep`,
usually under mpirun. Never import jax or fdtdx here; only meep and the
numpy-pure invdx modules (runio, fab.filters_np, fab.measure, modes,
engines.conventions).
