...
upstream tests pass; for strongly rectangular planes (our quasi-2D 800x4
cross-section) every grid point lands outside the truncation mask and the
...
horizontal transverse axis, matching pvgc's line-source convention
...
class GaussianBeamSource(LinearlyPolarizedPlaneSource):
    ...
    waist_radius in meters (1/e FIELD radius, matching pvgc's exp(-(x/w0)^2)).
    """
