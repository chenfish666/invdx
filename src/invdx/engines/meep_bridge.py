...
pvgc already ran its whole pipeline this way (mpirun + file exchange), so the
protocol is proven. Keep -np small for gate/smoke jobs: a production
optimization may be occupying the CPU cores.
"""
