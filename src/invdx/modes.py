"""Gaussian fiber mode & overlap power.
...
An earlier version of this code underestimated waveguide-side CE by exactly
2x, and nothing caught it until the reciprocity gate did: forward and reverse
excitation must agree, and a missing factor of 2 on one side of the pair
breaks that agreement while leaving each side individually plausible.
