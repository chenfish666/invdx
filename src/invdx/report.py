"""Results report: format a verification run's results.json into a Markdown
table, generated straight from the run directory so a quoted number can never
drift away from the data it was measured on.

    python -m invdx.report runs/<verify-run-dir> [...]

With several run dirs, emits one combined comparison table.
"""
