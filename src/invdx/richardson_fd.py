...
without gating on a single raw FD(h), which on some GPU architectures (Ada
measured 2026-08-21: FD errors GREW from h to h/2, 2.343e-07 -> 4.439e-07)
sits under its own float32 rounding noise floor rather than reflecting a real
