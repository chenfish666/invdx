...
RSoft column: run the exported case on the RSoft machine and append its
wall time by hand — the case definition (size/res/steps) is in the output
JSON so the comparison stays apples-to-apples.
"""
