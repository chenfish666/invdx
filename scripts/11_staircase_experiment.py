...
continuously swept geometry, with our own engines.
...
This turns the audit-fleet's source-reading claim ("binary fill breaks
continuous cross-verification") into a measured figure, and is the
methods-section justification for the engine division of labor:
grid-snapped geometry -> fdtdx; continuous sweeps -> Meep/RSoft.
